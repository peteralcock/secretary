...
def main():
    setup_database()  # Ensure the property management database is initialized
    ...
    state = supervisor_pm_workflow(selected_email, state)
...
def main():
    ...
    state = supervisor_pm_workflow(selected_email, state, your_name,recipient_name)
